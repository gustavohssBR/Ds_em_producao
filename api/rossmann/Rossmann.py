...
class Rossmann(object):
    def __init__(self):
        ...
        try:
            with open(self.home_path + 'parameter/competition_distance_scale.pkl', 'rb') as file:
                self.competition_distance_scale = pickle.load(file)
            with open(self.home_path + 'parameter/competition_time_month_scale.pkl', 'rb') as file:
                self.competition_time_month_scale = pickle.load(file)
            with open(self.home_path + 'parameter/promo_time_week__scale.pkl', 'rb') as file:
                self.promo_time_week__scale = pickle.load(file)
            with open(self.home_path + 'parameter/year_scale.pkl', 'rb') as file:
                self.year_scale = pickle.load(file)
            with open(self.home_path + 'parameter/store_type_scale.pkl', 'rb') as file:
                self.store_type_scale = pickle.load(file)
